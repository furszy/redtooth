...
public class ProposalUtil {
    ...
    public static String getBlocksLeftToChangeState(int chainHead,Proposal proposal){
        ...
        if (chainHead>proposal.getStartingBlock()){
            ...
            return StringUtils.formatNumberToString(vetoBlockStart-chainHead)+" blocks";
        }else if (chainHead>vetoBlockStart){
            return StringUtils.formatNumberToString(proposal.getStartingBlock()-chainHead) + " blocks";
        }
        return "";
    }
